...
jQuery(window).bind("load", function(){
	...
	//jQuery('.sliphoveritemTitle span').addClass('chaffle');
	//jQuery('.sliphoveritemTitle span').attr('data-lang','en');
